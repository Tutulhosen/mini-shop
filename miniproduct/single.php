          ...
          <div class="row">
            <div class="col-md-6">
              <div data-options="{&quot;animation&quot;: &quot;slide&quot;, &quot;controlNav&quot;: true}" class="flexslider nav-inside control-nav-dark">
                ...
                if (isset($_GET['slug'])) {
                  ...
                  $single_product_data= connector()->query("SELECT * FROM products WHERE slug='$slg'");

                  $single_product= $single_product_data->fetch_object();
                ...
                ?>
                  <li>
                    <img src="../assets/media/product/<?php echo $single_product->photo; ?>" alt="">
                  </li>
            ...
            <div class="col-md-5 col-md-offset-1">
              <div class="title mt-0">
                <h2 style="font-size:30px;"><?php echo $single_product->name; ?><span class="red-dot"></span></h2>
                
              </div>
              <div class="single-product-price">
                <div class="row">
                  <div class="col-xs-6">
                    <h3><del><?php echo $single_product->price; ?></del><span><?php echo $single_product->sprice; ?></span></h3>
                  </div>
