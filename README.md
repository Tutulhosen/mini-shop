##  A simple mini shop project
Its like a Ecommerce project

<img src="photo.png">

#### Our features
- upload and delect product with all features
- show it in the web page
- show the full product info
-search for product
-show the update product
              ...
              <div class="widget">
                ...
                <ul class="nav product-list">
                  <li>
                    ...
                    <div class="product-summary"><a href="single.php?tmb=<?php echo $tmb->id; ?>"><?php echo $tmb-> name ?></a><span><?php echo $tmb->price ?></span>
                    </div>
                  </li>
